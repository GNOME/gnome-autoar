 ...
 * #AutoarExtract::decide-dest is emitted. The signal provides the decided
 ...
 * destination directory will be notified via #AutoarExtract::decide-dest,
...
autoar_extract_step_decide_dest (AutoarExtract *arextract)
{
  ...
  autoar_extract_signal_decide_dest (arextract,
                                     priv->prefix != NULL ? priv->prefix : priv->destination_dir,
                                     files,
                                     &new_destination);
  ...
  if (new_destination != NULL) {
    ...
    g_debug ("autoar_extract_step_decide_dest: destination changed");
  }
